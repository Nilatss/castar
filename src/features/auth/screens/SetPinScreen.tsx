...
const GLOW1_WHITE = buildGlowSvg(GLOW_RENDER_SIZE, 'g1w', '#FFFFFF');
const GLOW1_GREEN = buildVividGlowSvg(GLOW_RENDER_SIZE, 'g1g', SUCCESS_GREEN);
const GLOW1_RED = buildVividGlowSvg(GLOW_RENDER_SIZE, 'g1r', ERROR_RED);
const GLOW2_WHITE = buildGlowSvg(GLOW2_RENDER_SIZE, 'g2w', '#FFFFFF');
const GLOW2_GREEN = buildVividGlowSvg(GLOW2_RENDER_SIZE, 'g2g', SUCCESS_GREEN);
const GLOW2_RED = buildVividGlowSvg(GLOW2_RENDER_SIZE, 'g2r', ERROR_RED);
